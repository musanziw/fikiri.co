...
export function About() {
  return (
    <div className={"p-8 bg-white"} id={"about"}>
      <div
        className={
          "lg:mx-auto border-t overflow-hidden lg:max-w-screen-lg py-20"
        }
      >
        ...
        <div className="w-full mt-8 inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)]">
