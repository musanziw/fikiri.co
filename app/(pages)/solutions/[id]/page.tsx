        ...
        {solution && (
          <>
            <div className="p-4 pt-24">
              ...
              <h2
                className={
                  "text-gray-600 text-2xl font-semibold mb-6 uppercase"
                }
              >
                {solution.name}
              </h2>
              ...
              <p className={"font-medium mb-4"}>{solution.description}</p>
            </div>
            <div className="p-4">
              <h2 className={"font-semibold text-xl mb-4"}>Problème résolu</h2>
              <p className={"font-medium mb-8"}>{solution.targetedProblem}</p>
            </div>
          </>
        )}
        {!solution && (
