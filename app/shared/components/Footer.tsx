          ...
          <div className="flex items-center gap-5">
            <Link href={""} className={"bg-indigo-600 p-2 rounded-full"}>
              <svg
                ...
                className="bi bi-telegram w-4 h-4 fill-gray-100"
                viewBox="0 0 16 16"
              >
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="bi bi-facebook w-4 h-4 fill-gray-100"
                viewBox="0 0 16 16"
              >
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="bi bi-instagram w-4 h-4 fill-gray-100"
                viewBox="0 0 16 16"
              >
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="bi bi-twitter-x w-4 h-4 fill-gray-100"
                viewBox="0 0 16 16"
              >
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="bi bi-linkedin w-4 h-4 fill-gray-100"
                viewBox="0 0 16 16"
              >
